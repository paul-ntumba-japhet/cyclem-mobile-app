...
class MenstrualCycleSummaryData {
  ...
  List<PeriodsDateRange>? cycleSummary;
  ...
  MenstrualCycleSummaryData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['cycle_summary'] != null) {
      cycleSummary = <PeriodsDateRange>[];
      json['cycle_summary'].forEach((v) {
        cycleSummary!.add(PeriodsDateRange.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (cycleSummary != null) {
      data['cycle_summary'] = cycleSummary!.map((v) => v.toJson()).toList();
    }
