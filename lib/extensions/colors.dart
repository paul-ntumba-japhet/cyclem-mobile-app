...
const yellowColor = Color(0xFFFFAB40);
...
// const thirdColor = Color(0xFFCC4669);
// const fourthColor = Color(0xFFFA658C);
const fifthColor = Color(0xFFfff3f6);
const navbarColor = Color(0xFFFF89A8);
const FollicularColor = Color(0xFFeec9b7);
const MenstruationColor = Color(0xFFff584f);
const OvulationColor = Color(0xFF22bc79);

const dividerColor = Color(0xFFD3D3D3);

//color variant
const whiteShade = Color(0xfff1f1f1);
const blackShade1 = Color(0xff020202);
const grayShade = Color(0xffb2b2b2);
