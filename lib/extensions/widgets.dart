...
AppBar appBarWidget(
  ...
  return AppBar(
      ...
      child: titleWidget ??
          Text(
            ...
            style: titleTextStyle ??
                (boldTextStyle(color: textColor ?? blackColor, size: textSize)),
            softWrap: true,
    ...
    backgroundColor: color ?? defaultAppButtonTextColorGlobal,
    leading: showBack
        ? (backWidget ?? BackButton(color: textColor ?? blackColor))
        : null,
