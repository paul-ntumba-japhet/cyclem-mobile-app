...
import 'package:era_flutter/screens/user/calculator/pregnancy_test_result.dart';
...
class PregnancyTestCalculator extends StatefulWidget {
  final CalculatorItem calculatorData;

  const PregnancyTestCalculator({super.key, required this.calculatorData});

  @override
  State<PregnancyTestCalculator> createState() =>
      _PregnancyTestCalculatorState();
}

class _PregnancyTestCalculatorState extends State<PregnancyTestCalculator> {
  ...
  void initState() {
    ...
    logScreenView("Pregnancy test calculator screen");
  }
      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            title: Text(
              language.pregnancyTestCalculator.capitalizeWords(),
              style: boldTextStyle(
                color: mainColorText,
                size: 18,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        AppButton(
                          ...
                          text: language.calculatePregnancyDays,
                          elevation: 0,
                          onTap: () {
                            if (_selectedDate != null &&
                                _selectedCycleLength != null) {
                              DateTime pregnancyTestDate = _selectedDate!
                                  .add(Duration(days: _selectedCycleLength!));
                              PregnancyTestResult(
                                      pregnancyTestDate: pregnancyTestDate)
                                  .launch(context);
                              logAnalyticsEvent(
                                  category: 'calculator',
                                  action: 'pregnancy_test_calculation');
                            }
                          },
                        ),
                        8.height,
